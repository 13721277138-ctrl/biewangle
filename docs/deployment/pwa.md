...
```sh
PLAYWRIGHT_BASE_URL=https://OWNER.github.io/biewangle/ pnpm --filter @biewangle/pwa e2e
```

发布证据、实际 OWNER、工作流运行地址和最终 URL 记录在 `evidence/pwa/g3-deployment-2026-08-30.md`，未取得真实 URL 前不得声称已经公网发布。
